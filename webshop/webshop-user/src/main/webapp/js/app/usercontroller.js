(function() {
	'use strict';
	angular.module('userapp').controller('UserCtrl', UserCtrl);
	UserCtrl.$inject = [ '$scope', '$rootScope', '$log', '$location',
			'UserService' ];
	function UserCtrl($scope, $rootScope, $log, $location, UserService) {
		$scope.login = login;
